# Lab 08 - Explainability Etica e Sicurezza Dati

## Obiettivo

- interpretare una predizione e collegarla a rischi etici, dati e GDPR.
- Collegare il risultato pratico ai micro-argomenti: Mini-laboratorio su explainability; Sicurezza dati/modelli, accessi e GDPR.
...
- Python, SHAP o LIME, checklist GDPR, tabella rischi.
...
- Il team lavora su mini-laboratorio explainability, etica, sicurezza dati e GDPR in una sessione uniforme da 4 ore.
...
2. Prepara una tabella con componenti, input, output, evidenze e rischio principale per mini-laboratorio explainability, etica, sicurezza dati e GDPR.
3. Esegui una mini-demo, una simulazione locale o una checklist guidata usando Python, SHAP o LIME, checklist GDPR, tabella rischi.
...
- mini-laboratorio explainability, etica, sicurezza dati e GDPR ModelOps guida
- Explainability Etica e Sicurezza Dati tutorial
- Python, SHAP o LIME, checklist GDPR, tabella rischi documentation
