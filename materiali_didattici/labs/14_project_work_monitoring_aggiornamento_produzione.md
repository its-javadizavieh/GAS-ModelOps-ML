# Lab 14 - Project Work Monitoring Aggiornamento Produzione

## Obiettivo

- completare monitoring, piano di aggiornamento e documentazione del project work.
- Collegare il risultato pratico ai micro-argomenti: Progetto finale a gruppi: pipeline completa dalla preparazione dati al monitoraggio e aggiornamento in produzione.
...
- MLflow, Prometheus, Grafana, Git, documentazione progetto.
...
- Il team lavora su project work, monitoraggio, aggiornamento e produzione in una sessione uniforme da 4 ore.
...
2. Prepara una tabella con componenti, input, output, evidenze e rischio principale per project work, monitoraggio, aggiornamento e produzione.
3. Esegui una mini-demo, una simulazione locale o una checklist guidata usando MLflow, Prometheus, Grafana, Git, documentazione progetto.
...
- project work, monitoraggio, aggiornamento e produzione ModelOps guida
- Project Work Monitoring Aggiornamento Produzione tutorial
- MLflow, Prometheus, Grafana, Git, documentazione progetto documentation
