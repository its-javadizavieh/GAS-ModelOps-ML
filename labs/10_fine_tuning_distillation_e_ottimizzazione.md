# Lab 10 - Fine Tuning Distillation e Ottimizzazione

## Obiettivo

- confrontare baseline, modello personalizzato e ipotesi di distillation.
- Collegare il risultato pratico ai micro-argomenti: Fine-tuning pipeline e modelli (HuggingFace/sklearn); Model distillation: teoria e pratica.
...
- HuggingFace, scikit-learn, notebook Python.
...
- Il team lavora su fine-tuning HuggingFace/sklearn, distillation e ottimizzazione in una sessione uniforme da 4 ore.
...
2. Prepara una tabella con componenti, input, output, evidenze e rischio principale per fine-tuning HuggingFace/sklearn, distillation e ottimizzazione.
3. Esegui una mini-demo, una simulazione locale o una checklist guidata usando HuggingFace, scikit-learn, notebook Python.
...
- fine-tuning HuggingFace/sklearn, distillation e ottimizzazione ModelOps guida
- Fine Tuning Distillation e Ottimizzazione tutorial
- HuggingFace, scikit-learn, notebook Python documentation
