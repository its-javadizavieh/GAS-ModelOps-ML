# Lab 12 - Tool Framework MLflow Kubeflow Vertex AI

## Obiettivo

- confrontare framework ModelOps e scegliere un setup motivato.
- Collegare il risultato pratico ai micro-argomenti: MLflow, Kubeflow, Vertex AI, demo introduttive.
...
- MLflow, Kubeflow, Vertex AI, scheda comparativa.
...
- Il team lavora su MLflow, Kubeflow, Vertex AI e demo introduttive in una sessione uniforme da 4 ore.
...
2. Prepara una tabella con componenti, input, output, evidenze e rischio principale per MLflow, Kubeflow, Vertex AI e demo introduttive.
3. Esegui una mini-demo, una simulazione locale o una checklist guidata usando MLflow, Kubeflow, Vertex AI, scheda comparativa.
...
- MLflow, Kubeflow, Vertex AI e demo introduttive ModelOps guida
- Tool Framework MLflow Kubeflow Vertex AI tutorial
- MLflow, Kubeflow, Vertex AI, scheda comparativa documentation
