# Lab 11 - Reinforcement Learning e RLHF

## Obiettivo

- modellare stato, azione, reward e feedback umano in uno scenario pratico.
- Collegare il risultato pratico ai micro-argomenti: Nozioni base RL, RLHF e applicazioni pratiche.
...
- lavagna, notebook Python opzionale, template di analisi.
...
- Il team lavora su nozioni base RL, RLHF e applicazioni pratiche in una sessione uniforme da 4 ore.
...
2. Prepara una tabella con componenti, input, output, evidenze e rischio principale per nozioni base RL, RLHF e applicazioni pratiche.
3. Esegui una mini-demo, una simulazione locale o una checklist guidata usando lavagna, notebook Python opzionale, template di analisi.
...
- nozioni base RL, RLHF e applicazioni pratiche ModelOps guida
- Reinforcement Learning e RLHF tutorial
- lavagna, notebook Python opzionale, template di analisi documentation
