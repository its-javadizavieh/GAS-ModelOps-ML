# Lab 09 - Permessi Audit e Fine Tuning Pipeline

## Obiettivo

- definire permessi audit e preparare una baseline per fine-tuning.
- Collegare il risultato pratico ai micro-argomenti: Esercitazioni su gestione permessi/audit; Fine-tuning pipeline e modelli (HuggingFace/sklearn).
...
- Git, checklist accessi, HuggingFace, scikit-learn, notebook.
...
- Il team lavora su gestione permessi, audit e avvio fine-tuning pipeline in una sessione uniforme da 4 ore.
...
2. Prepara una tabella con componenti, input, output, evidenze e rischio principale per gestione permessi, audit e avvio fine-tuning pipeline.
3. Esegui una mini-demo, una simulazione locale o una checklist guidata usando Git, checklist accessi, HuggingFace, scikit-learn, notebook.
...
- gestione permessi, audit e avvio fine-tuning pipeline ModelOps guida
- Permessi Audit e Fine Tuning Pipeline tutorial
- Git, checklist accessi, HuggingFace, scikit-learn, notebook documentation
